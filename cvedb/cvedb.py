...
class CvedbApi(CvedbApiBase):
    ...
    def find(self, query, limit=20, offset=0, fields=default_fields):
        """
        Search in Cvedb database.

        query: Cvedb query. See https://cvedb.github.io/help for the details.
    ...
    def find_all(self, query, limit=20, offset=0, fields=default_fields):
        """
        Search in Cvedb database and returns up to 10000 documents.
    ...
    def find_exploit(self, query, lookup_fields=None, limit=20, offset=0, fields=default_fields):
        """
        Search in Cvedb database for the exploits.
    ...
    def find_exploit_all(
        ...
        """
        Search in Cvedb database for the exploits and returns up to 10000 documents.
    ...
    query_autocomplete = Endpoint(
        ...
        description="Ask Cvedb for possible suggestions to complete your query",
        params=[("query", String(description="Cvedb Search query"))],
...
class DeprecatedCvedbApi(CvedbApi):
    def __init__(self, *args, **kwargs):
        super(DeprecatedCvedbApi, self).__init__(*args, **kwargs)
        warnings.warn(
            "Cvedb is deprecated and will be removed in future release. "
            "Use CvedbApi instead.",
            DeprecationWarning,
        )
    ...
    def searchExploit(self, query, lookup_fields=None, limit=100, offset=0, fields=None):
        warnings.warn(
            ...
            "Use CvedbApi.find_exploit_all() instead.",
            DeprecationWarning,
        )
    ...
    def searchExploitPage(self, query, lookup_fields=None, limit=100, offset=0, fields=None):
        warnings.warn(
            ...
            "Use CvedbApi.find_exploit() instead.",
            DeprecationWarning,
        )
        lookup_fields = lookup_fields or ()
        if isinstance(lookup_fields, (set, list)):
    ...
    def softwareVulnerabilities(self, name, version, maxVulnerabilities=_Unset):
        warnings.warn(
            ...
            "Use CvedbApi.get_software_vulnerabilities() instead.",
            DeprecationWarning,
        )
    ...
    def cpeVulnerabilities(self, cpeString, maxVulnerabilities=_Unset):
        warnings.warn(
            ...
            "Use CvedbApi.get_cpe_vulnerabilities() instead.",
            DeprecationWarning,
        )
        if maxVulnerabilities is not _Unset:
            warnings.warn(
    ...
    def document(self, identificator, fields=None):
        warnings.warn(
            ...
            "Use CvedbApi.get_bulletin() instead.",
            DeprecationWarning,
        )
    ...
    def documentList(self, identificatorList, fields=None):
        warnings.warn(
            ...
            "Use CvedbApi.get_multiple_bulletins() instead.",
            DeprecationWarning,
        )
    ...
    def references(self, identificator, fields=None):
        warnings.warn(
            ...
            "Use CvedbApi.get_bulletin_references() instead.",
            DeprecationWarning,
        )
    ...
    def referencesList(self, identificatorList, fields=None):
        warnings.warn(
            ...
            "Use CvedbApi.get_multiple_bulletin_references() instead.",
            DeprecationWarning,
        )
    ...
    def collections(self):
        warnings.warn(
            ...
            "Use CvedbApi.get_suggestion('type') instead.",
            DeprecationWarning,
        )
    ...
    def suggest(self, field_name):
        warnings.warn(
            ...
            "Use CvedbApi.get_suggestion() instead.",
            DeprecationWarning,
        )
    ...
    def aiScore(self, text):
        warnings.warn(
            ...
            "Use CvedbApi.get_ai_score() instead.",
            DeprecationWarning,
        )
    ...
    def rules(self):
        warnings.warn(
            ...
            "Use CvedbApi.get_web_application_rules() instead.",
            DeprecationWarning,
        )
    ...
    def kbSuperseeds(self, kb_identificator):
        warnings.warn(
            ...
            "Use CvedbApi.get_kb_seeds() instead.",
            DeprecationWarning,
        )
    ...
    def kbUpdates(self, kb_identificator, fields=None):
        warnings.warn(
            ...
            "Use CvedbApi.get_kb_updates() instead.",
            DeprecationWarning,
        )
    ...
    def autocomplete(self, query):
        warnings.warn(
            ...
            "Use CvedbApi.query_autocomplete() instead.",
            DeprecationWarning,
        )
    ...
    def archive(self, collection, start_date="1950-01-01", end_date="2199-01-01"):
        warnings.warn(
            ...
            "Use CvedbApi.get_collection() instead.",
            DeprecationWarning,
        )
    ...
    def distributive(self, os, version):
        warnings.warn(
            ...
            "Use CvedbApi.get_distributive() instead.",
            DeprecationWarning,
        )
        return self.get_distributive(os, version)


Cvedb = DeprecatedCvedbApi
